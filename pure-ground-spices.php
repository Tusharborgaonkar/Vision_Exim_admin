        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-4" data-aos="zoom-in">
                <div class="collections-card">
                    <div class="collections-img"><img src="/vision_exim/aaa.webp" alt="Fenugreek seeds"></div>
                    <h5><a href="/vision_exim/fenugreek-seeds.php">Fenugreek seeds</a></h5><a href="/vision_exim/fenugreek-seeds.php"
                        class="btn">VIEW Details<svg width="7" height="12" viewBox="0 0 7 12" fill="none"
            ...
            <div class="col-lg-3 col-md-4" data-aos="zoom-in">
                <div class="collections-card">
                    <div class="collections-img"><img src="/vision_exim/aaa.webp" alt="Mustard Seeds"></div>
                    <h5><a href="/vision_exim/fenugreek-seeds.php">Mustard Seeds</a></h5><a href="/vision_exim/fenugreek-seeds.php"
                        class="btn">VIEW Details<svg width="7" height="12" viewBox="0 0 7 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 10.5203L6 6.02026L1 1.52026" stroke="currentColor" stroke-width="1.6"
                                stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <div class="col-lg-3 col-md-4" data-aos="zoom-in">
                <div class="collections-card">
                    <div class="collections-img"><img src="/vision_exim/aaa.webp" alt="Sesame Seeds"></div>
                    <h5><a href="/vision_exim/fenugreek-seeds.php">Sesame Seeds</a></h5><a href="/vision_exim/fenugreek-seeds.php"
                        class="btn">VIEW Details<svg width="7" height="12" viewBox="0 0 7 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 10.5203L6 6.02026L1 1.52026" stroke="currentColor" stroke-width="1.6"
                                stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <div class="col-lg-3 col-md-4" data-aos="zoom-in">
                <div class="collections-card">
                    <div class="collections-img"><img src="/vision_exim/aaa.webp" alt="Coriander seeds"></div>
                    <h5><a href="/vision_exim/fenugreek-seeds.php">Coriander seeds</a></h5><a href="/vision_exim/fenugreek-seeds.php"
                        class="btn">VIEW Details<svg width="7" height="12" viewBox="0 0 7 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 10.5203L6 6.02026L1 1.52026" stroke="currentColor" stroke-width="1.6"
                                stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <div class="col-lg-3 col-md-4" data-aos="zoom-in">
                <div class="collections-card">
                    <div class="collections-img"><img src="/vision_exim/aaa.webp" alt="Fennel Seed"></div>
                    <h5><a href="/vision_exim/fenugreek-seeds.php">Fennel Seed</a></h5><a href="/vision_exim/fenugreek-seeds.php" class="btn">VIEW
                        Details<svg width="7" height="12" viewBox="0 0 7 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 10.5203L6 6.02026L1 1.52026" stroke="currentColor" stroke-width="1.6"
                                stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg></a>
            ...
            <div class="col-lg-3 col-md-4" data-aos="zoom-in">
                <div class="collections-card">
                    <div class="collections-img"><img src="/vision_exim/aaa.webp" alt="Cumin Seeds Singapore Quality"></div>
                    <h5><a href="/vision_exim/fenugreek-seeds.php">Cumin Seeds Singapore Quality</a></h5><a
                        href="/vision_exim/fenugreek-seeds.php" class="btn">VIEW Details<svg width="7" height="12" viewBox="0 0 7 12"
            ...
            <div class="col-lg-3 col-md-4" data-aos="zoom-in">
                <div class="collections-card">
                    <div class="collections-img"><img src="/vision_exim/aaa.webp" alt="Cumin Seeds Europe Quality"></div>
                    <h5><a href="/vision_exim/fenugreek-seeds.php">Cumin Seeds Europe Quality</a></h5><a href="/vision_exim/fenugreek-seeds.php"
                        class="btn">VIEW Details<svg width="7" height="12" viewBox="0 0 7 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 10.5203L6 6.02026L1 1.52026" stroke="currentColor" stroke-width="1.6"
                                stroke-linecap="round" stroke-linejoin="round"></path>
